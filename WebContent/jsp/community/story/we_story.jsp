	...
	<%
		...
		if(mvo != null && mvo.getM_TYPE().equals("0")){
			...
			if(c_value != null && keyword != null  && !keyword.equals("") && !keyword.contains("null")){
				totalRecord = CommDAO.sGetTotalCount(m_type, c_value, keyword);	
			}else{
			...
			<div class="sub_box1">
				...
				<div class="sub_layout2">
					...
					<div class="search_area">
						...
						%>
						<a href="story_write.jsp?cPage=<%=nowPage%>"
							class="search_btn btn_write">글쓰기</a>
						<%
							}
							}
						%>
						<form action="we_story.jsp" name="searchForm" method="post">
							...
							<a href="#" onclick="goSearch()" class="search_btn">검색</a>
						</form>
					</div>
					<ul class="board_list">
						...
						if(c_value != null && keyword != null  && !keyword.equals("") && !keyword.contains("null")){
							...
							ar = CommDAO.sProjectList(begin, end, m_type, c_value, keyword);
							//if(ar != null)
							//System.out.println(ar[0].getC_title());
						}else{
						
						 	ar = CommDAO.getList(begin, end, m_type);
						}
					...
					%>
						...
						<li>
							<div class="layout">
								...
								<div class="img">
									<a
										href="story_view.jsp?c_idx=<%=vo.getC_idx()%>&cPage=<%=nowPage%>">
										<img src="../../../upload/<%=vo.getC_img()%>" />
									</a>
								</div>
								<div class="gallery">
									<h1><%=vo.getC_title()%></h1>
					...
					<div class="paging">
						...
						%>
						<span><a
							href="we_story.jsp?cPage=<%=nowPage - pagePerBlock%>"><img
						...
						<span>
						<a
							href="we_story.jsp?cPage=<%=nowPage + pagePerBlock%>"></a>

		...
		<div class="sub_layout">
			...
			<div class="sub_box1">
				<div class="sub_layout2">
					...
					<!-- 글쓰기 -->
					<div class="sub_write">
						<form action="study_write_ok.jsp" name="frm1" method="post"
							...
							<table class="table_style" summary="게시판 글쓰기">
								...
								<tbody>
									...
									<tr>
										<th>작성자:</th>
										<td><input type="text" id="writer" class="writer"
											name="writer" value=""
											style="width: 100px;" />
									...
									<tr>
										<th>분류:</th>
										<td><select id="c_video" name="c_video"
											style="width: 130px;">
												<option>::강의 선택::</option>
												<option value="j">자바강의</option>
												<option value="a">안드로이드강의</option>
												<option value="s">SQL강의</option>
												<option value="w">웹프로그래밍강의</option>
										</select></td>
									</tr>
									<tr>
										<th>내용:</th>
									...
									<tr>
										...
										<input type="button" class="btn_style"
											value="저장" onclick="sendData()" /> <input type="button"
